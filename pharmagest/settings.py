"""
Django settings for pharmagest project.
...
WSGI_APPLICATION = 'pharmagest.wsgi.application'
...
STATICFILES_STORAGE = 'whiteoise.storage.CompressedManifestStaticFilesStorage'
